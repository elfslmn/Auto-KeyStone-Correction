...
namespace ark {
    ...
    public:
        ...
        /**
         * threshold thickness of the plane, i.e. the maximum distance to
         * the plane at which a point is considered to be 'touching' it
         * default 0.0002 (m^2)
         */
        double touchThreshold = 0.0007; //plane eq çok hassas olmadıgı için thresh kucuk dokununca algılamıyo
         ...
         * default: 0.06
         * 0.25 for low exposure
         */
        float planeFloodFillThreshold = 0.15f;
         ...
         * default: 0.0025
         */
        double planeCombineThreshold = 0.005;
